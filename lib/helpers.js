...
module.exports = {
    ...
    getStatus: (num, name, id) => {
        return (num > 0) ? (
            `<div class="card-header bg-dark navbar navbar-expand-lg d-inline navbar-dark">
            <div class="row d-flex align-items-center">
                <div class="col col-lg-9">
                    <a href="/client/details/${id}" class="stretched-link"></a>
                    <p class="h5 text-uppercase text-center m-0 text-light">${name}</p>

                    </div>`
        ) : (`<div class="card-header bg-light navbar navbar-expand-lg d-inline navbar-light">
        <div class="row d-flex align-items-center">
            <div class="col col-lg-9">
                <a href="/client/details/${id}" class="stretched-link"></a>
                <p class="h5 text-uppercase text-center m-0 text-dark">${name}</p>
